...
local startButton = Button("Start",CanvasWidth/2 - 150,CanvasHeight/2 - 25,300,50,function() ChangeScreen(2) end,love.graphics.newFont(25),{1,1,1},{0.8,0.1,0.1})
...
function StartScreen:drawUI()
    ...
    local titleText = "Project: Hindsight"
